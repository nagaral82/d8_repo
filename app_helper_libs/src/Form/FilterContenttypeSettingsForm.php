 ...
 */
class FilterContentTypeSettingsForm extends ConfigFormBase {
  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'filter_content_type_admin_settings';
  }
 ...
 /**
  ...
  public function getContentTypesByLang($selected) {
    ...
    $data = $config->get('content_type_by_lang');
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
   $form = parent::buildForm($form, $form_state);
    ...
    $defaultArr = $config->get('content_type_by_lang.'.$selected); 
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('app_helper_libs.settings')
         ->set('content_type_by_lang.'.$lang, $defaultArr)
         ->save();
