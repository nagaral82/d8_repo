 ...
 */
class BlogSeeAllPopularTopicSettingsForm extends ConfigFormBase {
  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'blog_see_all_popular_topic_admin_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
	...
	$defaultArr = $config->get('blog_see_all_popular_topic.'.$selected); 
  ...
  public function getDefaultTopics($selected) {
    ...
    $data = $config->get('blog_see_all_popular_topic');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    */
    ...
    $this->config('app_helper_libs.settings')
         ->set('blog_see_all_popular_topic.'.$lang, $defaultArr)
         ->set('blog_popular_topic.'.$lang, $popularTopicArr)
         ->save();
