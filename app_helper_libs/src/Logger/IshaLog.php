...
namespace Drupal\app_helper_libs\Logger;
 ...
 */
class appLog implements LoggerInterface {
  use RfcLoggerTrait;
  ...
  protected $parser;
  /**
   * The logger DB table name.
   *
   * @var string
   */
  protected $loggerTable = 'app_log';
  /**
  ...
  public function log($level, $message, array $context = []) {
	// If the custom log table doesn't exists, simply ignore the records
	if (!$this->connection->schema()->tableExists($this->loggerTable)) {
		return;
	}		
